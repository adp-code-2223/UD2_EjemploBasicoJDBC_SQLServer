...
public class UD2_EjemploBasicoJDBC_SQLServer {
    ...
    public static void main(String[] args) {
        ...
        try (
                 Connection conexion = DriverManager.getConnection(url);  Statement sentencia = conexion.createStatement();  ResultSet result = sentencia.executeQuery("SELECT * FROM dbo.DEPT");) {
